...
import com.hansel.FriseurPlan.core.application.usecase.hairdresser.command.HairdresserCommandsUseCase;
...
public class HairdresserController {
    ...
    private final HairdresserCommandsUseCase hairdresserCommandsUseCase;
    ...
    public ResponseEntity<Hairdresser> createHairdresser(@RequestBody @Valid HairdresserDto hairdresserDto,@AuthenticationPrincipal Jwt jwt) {
        ...
        Hairdresser hairdresser = this.hairdresserCommandsUseCase.createHairdresser(hairdresserDto,email);
